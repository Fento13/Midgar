...
public class App {
    ...
    public static void Ejercicio5() {
        /*5. Haz un programa que lea por teclado una cadena y muestre una estructura como la del ejemplo para "CADENA":
...
PRUEBA*/
    ...
    public static void Ejercicio8() {
        /*
2. Haz un programa que, dada una cadena, muestre cuántas vocales tiene, tanto mayúsculas como minúsculas.
 */
        String cadena;
        System.out.println("Ingrese una cadena de texto:");
        cadena = sc.nextLine();
    ...
    /*
3. Haz un programa que, dada una cadena, elimine todos los dígitos (es decir, caracteres del '0' al '9') que tenga. Para ello, investiga cómo funciona el método replaceAll() de los strings.
 */
        String cadena;
        System.out.println("Ingrese una cadena de texto:");
        cadena = sc.nextLine();
    ...
    public static void Ejercicio10() {
        /*4. Haz un programa que pida al usuarios dos cadenas, C1 y C2.
         Después, dirá si la cadena C1 está contenida en C2. Ejemplo: si C1 es "hola" y C2 es "hola qué tal",
          dirá "'hola' está contenido en 'hola que tal'". Otro ejemplo: si C1 es "adiós" y C2 es "hola qué tal", dirá "'adiós'
           NO está contenido en 'hola qué tal'". Para ello, investiga cómo funciona el método contains() de los strings.
*/
